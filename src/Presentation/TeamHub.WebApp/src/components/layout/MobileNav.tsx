...
export default function MobileNav({
  ...
  return (
    ...
    >
        ...
        <nav className="flex flex-col gap-2 px-4">
          {["Features", "About", "Contact"].map((item) => (
            <button
              ...
              className="group flex items-center px-3 py-2 rounded-md text-muted-foreground hover:bg-muted hover:text-foreground transition-all duration-200 text-left"
            >
      ...
      <div className="border-t border-border p-4 bg-card flex flex-col gap-3">
        <Button
          variant="ghost"
