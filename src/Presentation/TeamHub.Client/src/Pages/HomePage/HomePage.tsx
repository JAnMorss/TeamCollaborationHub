...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-100 via-white to-blue-50 relative">
      <Navbar />
          ...
          <div className="space-y-10">
            <div>
              ...
              <p className="text-lg md:text-xl text-gray-700 max-w-xl mx-auto lg:mx-0">
                Organize projects, share ideas, and communicate effortlessly all in
                one powerful platform. Experience the future of team collaboration.
              </p>
            </div>
